...
protoc -Iproto/ -I$GOPATH/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis -I/usr/local/include --grpc-gateway_out=logtostderr=true:rest-server proto/*.proto